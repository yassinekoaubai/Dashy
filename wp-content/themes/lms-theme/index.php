          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="features-item first-feature wow fadeInUp mb-5 mb-5" data-wow-duration="1s" data-wow-delay="0s">
                ...
                <div class="icon"></div>
                <h4>L’histoire de Dashy : Redéfinir l’inclusion financière</h4>
            ...
            <div class="col-lg-12">
              <div class="features-item second-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                ...
                <h4>Notre Mission</h4>
                <div class="line-dec"></div>
                <p>Dashy incarne une nouvelle approche de l’inclusion financière. En combinant notre expertise approfondie du secteur bancaire avec les technologies les plus innovantes, nous développons des solutions qui transforment l’accès aux services financiers modernes. Notre ambition est claire : démocratiser ces services en les rendant plus accessibles, plus intuitifs et parfaitement adaptés aux besoins de chacun.</p>
              </div>
            </div>
          </div>
        </div>
