(e=>{e.vc||(e.vc={}),e.vc.utils={fixUnclosedTags:function(e){return e.replace(/<\/([^>]+)$/g,"&#60;/$1").replace(/<([^>]+)?$/g,"&#60;$1")},fallbackCopyTextToClipboard:function(e){var t=document.createElement("textarea");t.value=e,t.style.top="0",t.style.left="0",t.style.position="fixed",document.body.appendChild(t),t.focus(),t.select();try{document.execCommand("copy")}catch(e){console.error("Unable to copy",e)}},copyTextToClipboard:function(e){navigator.clipboard?navigator.clipboard.writeText(e):this.fallbackCopyTextToClipboard.call(this,e)},slugify:function(e){return(e=e||"").toString().toLowerCase().replace(/[^a-z0-9\s-]/g," ").replace(/[\s_-]+/g,"-").replace(/^-+|-+$/g,"")},stripHtmlTags:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}})(window);
